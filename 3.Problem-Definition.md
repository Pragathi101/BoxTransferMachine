...
|8|What features can we expect from the machine?|It must sense the boxes, transfer of boxes easily, count the number of boxes transfered and alert process completion|Function|
